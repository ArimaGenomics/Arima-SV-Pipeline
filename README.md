...
```
wget ftp://ftp-arimagenomics.sdsc.edu/pub/singularity/Arima-SV-Pipeline-singularity-v1.2.sif
```
...
Arima-SV-Pipeline-v1.2.sh [-W run_hicup] [-B run_hic_breakfinder] [-J run_juicer]
