...
# bash Arima-SV-Pipeline-v1.3.sh -W 1 -B 1 -J 1 -H 0 -a ~/tools/bowtie2-2.3.4.3-linux-x86_64/bowtie2 -b ~/tools/hic_breakfinder/bin/ -w ~/tools/HiCUP-0.8.0/ -j ~/tools/juicer_v1.6/ -r ~/scratch/reference/hg19.fa -s ~/scratch/reference/Juicer/hg19.chrom.sizes -c ~/tools/juicer_v1.6/restriction_sites/hg19_GATC_GANTC.txt -x ~/reference/bowtie2/hg19 -d ~/reference/HiCUP/Digest_hg19_Arima.txt -I ~/fastq/AGI_2_25M_R1.fastq.gz,~/fastq/AGI_2_25M_R2.fastq.gz -o ~/tmp/FFPE/ -p 100M_mytest -e ~/tmp/FFPE/utils/intra_expect_100kb.hg19.txt -E ~/tmp/FFPE/utils/inter_expect_1Mb.hg19.txt -t 12 -S 0 -C 0

# bash Arima-SV-Pipeline-v1.3.sh -W 0 -B 0 -J 0 -H 0 -a ~/tools/bowtie2-2.3.4.3-linux-x86_64/bowtie2 -b ~/tools/hic_breakfinder/bin/ -w ~/tools/HiCUP-0.8.0/ -j ~/tools/juicer_v1.6/ -r ~/scratch/reference/hg38.fa -s ~/scratch/reference/Juicer/hg38.chrom.sizes -c ~/tools/juicer_v1.6/restriction_sites/hg38_GATC_GANTC.txt -x ~/reference/bowtie2/hg38 -d ~/reference/HiCUP/Digest_hg38_Arima.txt -I ~/fastq/002DS_1_R1.fastq.gz,~/fastq/002DS_1_R2.fastq.gz -o ~/tmp/FFPE/ -p 002DS_1 -e ~/tmp/FFPE/utils/intra_expect_100kb.hg38.txt -E ~/tmp/FFPE/utils/inter_expect_1Mb.hg38.txt -t 4 -S 0 -C 0
