...
# bash Arima-SV-Pipeline-v1.2.sh -W 1 -B 1 -J 1 -H 0 -a /home/xiangz/tools/bowtie2-2.3.4.3-linux-x86_64/bowtie2 -b /home/xiangz/tools/hic_breakfinder/bin/ -w /home/xiangz/tools/HiCUP-0.8.0/ -j /home/xiangz/tools/juicer_v1.6/ -r /home/xiangz/scratch/reference/hg19.fa -s /home/xiangz/scratch/reference/Juicer/hg19.chrom.sizes -c /home/xiangz/tools/juicer_v1.6/restriction_sites/hg19_GATC_GANTC.txt -x /oasis/tscc/scratch/xiangz/reference/bowtie2/hg19 -d /oasis/tscc/scratch/xiangz/reference/HiCUP/Digest_hg19_Arima.txt -I /oasis/tscc/scratch/xiangz/CHiCAGO/Arima_CHiC/fastq/AGI_2_25M_R1.fastq.gz,/oasis/tscc/scratch/xiangz/CHiCAGO/Arima_CHiC/fastq/AGI_2_25M_R2.fastq.gz -o /oasis/tscc/scratch/xiangz/tmp/FFPE/ -p 100M_mytest -e /oasis/tscc/scratch/xiangz/tmp/FFPE/utils/intra_expect_100kb.hg19.txt -E /oasis/tscc/scratch/xiangz/tmp/FFPE/utils/inter_expect_1Mb.hg19.txt -t 12 &> SV.log

# bash Arima-SV-Pipeline-v1.2.sh -W 0 -B 0 -J 0 -H 0 -a /home/xiangz/tools/bowtie2-2.3.4.3-linux-x86_64/bowtie2 -b /home/xiangz/tools/hic_breakfinder/bin/ -w /home/xiangz/tools/HiCUP-0.8.0/ -j /home/xiangz/tools/juicer_v1.6/ -r /home/xiangz/scratch/reference/hg38.fa -s /home/xiangz/scratch/reference/Juicer/hg38.chrom.sizes -c /home/xiangz/tools/juicer_v1.6/restriction_sites/hg38_GATC_GANTC.txt -x /oasis/tscc/scratch/xiangz/reference/bowtie2/hg38 -d /oasis/tscc/scratch/xiangz/reference/HiCUP/Digest_hg38_Arima.txt -I /oasis/tscc/scratch/xiangz/tmp/FFPE/fastq/002DS_1_R1.fastq.gz,/oasis/tscc/scratch/xiangz/tmp/FFPE/fastq/002DS_1_R2.fastq.gz -o /oasis/tscc/scratch/xiangz/tmp/FFPE/ -p 002DS_1 -e /oasis/tscc/scratch/xiangz/tmp/FFPE/utils/intra_expect_100kb.hg38.txt -E /oasis/tscc/scratch/xiangz/tmp/FFPE/utils/inter_expect_1Mb.hg38.txt -t 4 &> SV.log
